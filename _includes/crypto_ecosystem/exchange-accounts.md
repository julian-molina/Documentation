...
{% assign title = "Exchange Accounts" %}
{% assign definition = site.data.crypto_ecosystem.exchange_accounts %}
...
{% include note.html content="Only one exchange accounts node may exist on each exchange." %}
