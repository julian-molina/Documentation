...
{% assign title = "Polygon Body" %}
{% assign definition = site.data.data_mine.polygon_body %}
...
<details class='detailsCollapsible'><summary class='nobr'>Click to learn more about polygon bodies
</summary>
{% endif %}
