...
{% assign title = "Snapshots" %}
{% assign definition = site.data.network.snapshots %}
...
Learn more about [snapshots](suite-snapshots.html) and check the configuration file to control if and how snapshots are produced.
