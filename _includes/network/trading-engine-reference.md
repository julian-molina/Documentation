...
{% assign title = "Trading Engine Reference" %}
{% assign definition = site.data.network.trading_engine_reference %}
...
{% include note.html content="After adding a trading engine reference node, make sure you establish the reference to the corresponding trading engine hierarchy." %}
