...
procedure_loop: "The procedure loop holds the JavaScript code that reads an input, processes the information, and generates an output in a recursive manner."
...
point_formula: "A point formula is the node used to input the [x,y] coordinates of a point."
